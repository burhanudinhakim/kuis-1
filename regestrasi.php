...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="container">
        ...
        <form class="form-horizontal" method="post" action="client_regestrasi_332376.php">
<fieldset>
...
<div class="form-group">
  ...
  <div class="radio">
    <label for="Jenis Kelamin-0">
      <input type="radio" name="jk" id="Jenis Kelamin-0" value="L" checked="checked">
      Laki-laki
    </label>
  </div>
  <div class="radio">
    <label for="Jenis Kelamin-1">
      <input type="radio" name="jk" id="Jenis Kelamin-1" value="P">
      Perempuan
    </label>
  </div>
  </div>
