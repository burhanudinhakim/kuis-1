<?php
  ...
  $server->register('login_ws', 
    ...
    function register($email,$nim,$nama,$jenis_kelamin,$alamat){
       $db = NewADOConnection('mysql');
       $db -> connect('128.199.182.167','kuis1','rahasia','kuis1');
       $sql = $db -> Execute("INSERT INTO pengguna ('email','nim','nama','jenis_kelamin','alamat') VALUES ('$email','$nim','$nama','$jk','$alamat')");
    }
