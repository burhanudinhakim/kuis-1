  ...
  <!-- Fixed navbar -->
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h3>Tugas</h3>
        <ul>
          <li>Buatlah form untuk registrasi pengguna menggunakan nusoap untuk mendaftarkan peserta</li>
          <li>Repository git : https://github.com/burhanudinhakim/kuis-1.git</li>
          <li>Gunakan Pull Request, bukan PUSH</li>
          <li>Server : server_registrasi_[nim].php</li>
          <li>Client : client_registrasi_[nim].php</li>
          <li>Menggunakan database : HOST = '128.199.182.167' USER ='kuis1' PASS ='rahasia', TABEL = 'pengguna'</li>
        </ul>
      </div>
