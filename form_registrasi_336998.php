...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="container">
      ...
      <div>
        <form class="form-horizontal" action="client_registrasi_336998.php" method="POST"> <!-- ini dikasih action ke client_registrasi.php. knp POST? ntar harus post juga di client -->
<fieldset>
